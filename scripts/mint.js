...
const toaddress = "0x12B4BA356E6C17275f9E817C79525E7773E68CCB";
...
async function main() {
  ...
  rl.question("Please enter the amount to mint: ", async (amtInput) => {
    ...
    const tx = await token.mints(toaddress, amt);
    await tx.wait();
    console.log("The minting at address: " + toaddress + " was successful");
    console.log( amt + " is the minted amount");
